...
const ResenasPage: React.FC = () => {
        ...
        <CardContent>
          ...
          <Box sx={{ display: 'flex', gap: 1, mt: 1 }}>
            <Button
              ...
              variant={expandedRow === r.id ? 'contained' : 'outlined'}
              sx={
                expandedRow === r.id
                  ? { backgroundColor: '#5d4037', fontFamily: 'Montserrat, sans-serif' }
                  : { color: '#5d4037', fontFamily: 'Montserrat, sans-serif' }
              }
            >
              Responder
            </Button>
  ...
  <Paper sx={{ height: 'auto', width: '100%', backgroundColor: '#ffffff', fontFamily: 'Montserrat, sans-serif' }}>
    <DataGrid
      rows={filteredRows}
      columns={columns}
      autoHeight
